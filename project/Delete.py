    ...
    def __init__(self):
        ...
        def ent():
            if len(a.get()) ==0:
                ...
                d = messagebox.askyesno("Confirm", "Are you sure you want to delete the Project?")
                if d:
                    try:
                        ...
                        if self.myCursor.rowcount == 0:
                            ...
                            messagebox.showinfo("Confirm","Project Deleted Successfully")
                        self.myCursor.close()
                        self.conn.close()
                        a.set("")
                        ...
                        raise e
        Label(self, text = "Enter Group No.: ",bg='gray',fg='black',font=('Courier new', 15, 'bold')).place(x = 5,y = 40)
